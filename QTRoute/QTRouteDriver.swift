...
fileprivate extension QTRouteDriver {
    static func routeNext(path: QTRoutePath, routable: QTRoutable?, input: QTRoutableInput, finalCompletion: QTRoutableCompletion?) {
    ...
    static func driveRoutable(_ routable: QTRoutable, _ pathNode: QTRoutePathNode, input: QTRoutableInput, _ stepCompletion: @escaping QTRoutableCompletion) {
    ...
    static func getStepCompletion(_ path: QTRoutePath, input: QTRoutableInput, _ finalCompletion: QTRoutableCompletion?) -> QTRoutableCompletion {
